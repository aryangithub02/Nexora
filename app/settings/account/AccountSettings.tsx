                    ...
                    <div className="bg-[#161B22] border border-[#2A2F3A] rounded-2xl p-6 w-full max-w-md shadow-2xl space-y-6">
                        ...
                        <div className="space-y-4">
                            <input
                                ...
                                className="w-full bg-white border border-[#2A2F3A] rounded-lg px-4 py-3 text-black text-center tracking-[0.5em] font-mono text-lg focus:border-[#2DE2A6] outline-none"
                                maxLength={6}
                            />
                            <div className="flex gap-3">
                                <button
