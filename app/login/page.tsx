...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-main)] px-4 py-10 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full blur-3xl pointer-events-none" style={{ background: "radial-gradient(ellipse, rgba(79,140,255,0.06) 0%, transparent 70%)" }} />
      ...
      <div className="w-full max-w-sm bg-[var(--bg-card)] border border-[var(--border-soft)] rounded-3xl p-6 shadow-[0_24px_80px_rgba(0,0,0,0.5)] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-48 h-48 rounded-full blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/2" style={{ background: "rgba(78,242,178,0.04)" }} />

        <div className="mb-6">
          <h1 className="text-2xl font-bold text-white font-[family-name:var(--font-space-grotesk)] mb-1">Welcome back</h1>
          <p className="text-sm text-[var(--text-muted)] font-[family-name:var(--font-inter)]">Sign in to continue your journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-[11px] font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-2 font-[family-name:var(--font-jetbrains-mono)]">Email</label>
            <input
              id="login-email"
              type="email"
              value={email}
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label htmlFor="login-password" className="block text-[11px] font-semibold text-[var(--text-muted)] uppercase tracking-wider font-[family-name:var(--font-jetbrains-mono)]">Password</label>
              <Link href="/forgot-password" className="text-xs text-[var(--accent)] hover:text-white transition-colors font-[family-name:var(--font-inter)]">Forgot?</Link>
            </div>
        ...
        <p className="text-center text-sm text-[var(--text-muted)] mt-5 font-[family-name:var(--font-inter)]">
          ...
          <Link href="/register" className="text-[var(--accent)] hover:text-white transition-colors font-semibold">Sign up</Link>
        </p>
      </div>
    </div>
  );
